...
const EmailSubscribe: React.FC = () => {
  ...
  return (
    <section className="py-20 px-4 bg-off-white relative overflow-hidden">
      {/* Background elements */}
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-street-brown-200 rounded-full opacity-20 blur-3xl"></div>
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <form onSubmit={handleSubmit} className="max-w-md mx-auto px-4">
          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-r from-street-blue-500 to-street-brown-500 rounded-full blur opacity-20 group-hover:opacity-40 transition-opacity duration-300"></div>
            <div className="relative flex flex-col sm:flex-row items-stretch sm:items-center bg-white rounded-full shadow-2xl overflow-hidden border-2 border-transparent group-hover:border-street-blue-400 transition-colors duration-300">
              ...
              <button
                ...
                className="px-6 py-4 bg-street-brown-700 hover:bg-street-brown-800 text-off-white font-inter font-semibold transition-all duration-300 flex items-center justify-center space-x-2 group rounded-b-full sm:rounded-b-none sm:rounded-r-full"
              >
                <span className="hidden sm:block uppercase tracking-wide text-sm">Notify Me</span>
